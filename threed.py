...
file_cov = "~/data/noProt_UKB_drug.txt.gz"
root = "~/plot3d/"
file_score_lpa = '~/proj/LPA/phewas-clinical/jc-lpa.sscore'
file_score_PCSK9 = '~/proj/LPA/phewas-clinical/best.score'
file_valid = '~/proj/phewas/d118/White-rm2nd.val'
file_white = '~/proj/d118/White-rm2nd.eid'
lpa = '~/proj/LPA/data/pheno/lpa.pheno'
...
sv.to_csv(root + 'plot3d.tsv', index=False, sep='\t')
